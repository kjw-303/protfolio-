export default function Services() {
  return (
    <section className="services" id="services">
      <ul className="service-tile is-cyan" data-hover data-cursor="Web">
        <li className="has-cursor-label">
      ...
      <ul className="service-tile is-black" data-hover data-cursor="App">
        <li className="has-cursor-label">
          <strong className="tile-title">App &amp; UX Planning</strong>
          <span className="tile-desc">앱 화면설계부터 와이어프레임까지. 개발팀과 원활하게 협업할 수 있는 산출물.</span>
        </li>
      </ul>
      <ul className="service-tile is-grey" data-hover data-cursor="RWD">
        <li className="has-cursor-label">
